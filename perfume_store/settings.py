...
# Ваш пользовательский домен (если есть)
...
MIDDLEWARE = [
    ...
    'django.middleware.csrf.CsrfViewMiddleware',  # Временно отключите для тестирования
...
# Настройка для Vercel - для статических файлов


# Добавьте Whitenoise для обработки статических файлов
